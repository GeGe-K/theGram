...
class ProfileTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.profile = Profile(bio='bio example')
...
class ImageTestClass(TestCase):
    ...
    def setUp(self):
        self.image = Image(name='example', caption='living')
        self.image.save_image()

        self.image = Image(name='example', image='example.jpg', caption='living',posted_on='two minutes ago', profile=self.profile)
    ...
    #         caption='example caption').update(caption='example')
...
class CommentTestClass(TestCase):
    ...
    def setUp(self):
      self.comment = Comment(comment='creation')
